...
This repository contains the code for Deep Reinforcement Learning Nano Degree's third project. In this project, we work with the [Tennis](https://github.com/Unity-Technologies/ml-agents/blob/master/docs/Learning-Environment-Examples.md#tennis) environment.
...
Follow the instructions in `Tennis.ipynb` to train the agent and use `Run_Agent.ipynb` to see the performance of the agents.# Environment
